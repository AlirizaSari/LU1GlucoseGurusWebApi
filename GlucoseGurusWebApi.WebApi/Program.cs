...
builder.Services.AddTransient<ITrajectCareMomentRepository, SqlTrajectCareMomentRepository>(provider => new SqlTrajectCareMomentRepository(sqlConnectionString));
